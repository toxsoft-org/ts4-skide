 ...
 * @author hazard157
 */
public class SkideUnitTaskUploadConfig
  ...
  SkideUnitTaskUploadConfig( ITsGuiContext aContext, AbstractSkidePlugin aCreator ) {
  ...
  protected AbstractSkideUnitPanel doCreateUnitPanel( ITsGuiContext aContext ) {
    return new SkideUnitTaskUploadConfigPanel( aContext, this );
  }
